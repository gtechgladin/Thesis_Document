...
\fbox{
  \parbox{\textwidth}{
Observation 12:  The assumptions about BLI component performance (e.g. inlet, fan, nacelle drag, etc.) have a strong impact on the final fuel burn analysis.
\vspace{5 mm}
	
Observation 13:  Because of the physical coupling between the components, the component efficiency assumptions are correlated and are functions of flight conditions and engine ingested mass flow.
\vspace{5 mm}
